...
start:
  ...
  br i1 %0, label %panic.i, label %"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17hb5a4ec9d16c0ef01E.exit"

panic.i:                                          ; preds = %start
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h03037c13d16e57f8E([0 x i8]* align 1 bitcast ([25 x i8]* @str.0 to [0 x i8]*), i64 25, %"core::panic::location::Location"* align 8 bitcast (<{ i8*, [16 x i8] }>* @alloc4 to %"core::panic::location::Location"*)) #3
  unreachable

"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17hb5a4ec9d16c0ef01E.exit": ; preds = %start
  br label %bb1

bb1:                                              ; preds = %"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17hb5a4ec9d16c0ef01E.exit"
  ret void
}
...
declare void @_ZN4core9panicking5panic17h03037c13d16e57f8E([0 x i8]* align 1, i64, %"core::panic::location::Location"* align 8) unnamed_addr #2
