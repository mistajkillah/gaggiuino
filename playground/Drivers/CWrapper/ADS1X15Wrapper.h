...
ADS1X15Wrapper createADS1X15Wrapper(void* bus, char devAddr, const char* name);
...
void setModeADS1X15Wrapper(ADS1X15Wrapper instance, char mode);

// Function to get the mode of the ADS1X15Wrapper
char getModeADS1X15Wrapper(ADS1X15Wrapper instance);

// Function to set the data rate of the ADS1X15Wrapper
void setDataRateADS1X15Wrapper(ADS1X15Wrapper instance, char dataRate);

// Function to get the data rate of the ADS1X15Wrapper
char getDataRateADS1X15Wrapper(ADS1X15Wrapper instance);

// Function to read ADC value from the ADS1X15Wrapper
int readADCADS1X15Wrapper(ADS1X15Wrapper instance, char pin);

// Function to read differential ADC value from the ADS1X15Wrapper
int readADCDifferentialADS1X15Wrapper(ADS1X15Wrapper instance, char positivePin, char negativePin);

// Function to request ADC value asynchronously from the ADS1X15Wrapper
void requestADCADS1X15Wrapper(ADS1X15Wrapper instance, char pin);
...
char lastRequestADS1X15Wrapper(ADS1X15Wrapper instance);

// Function to set the comparator mode of the ADS1X15Wrapper
void setComparatorModeADS1X15Wrapper(ADS1X15Wrapper instance, char mode);

// Function to get the comparator mode of the ADS1X15Wrapper
char getComparatorModeADS1X15Wrapper(ADS1X15Wrapper instance);

// Function to set the comparator polarity of the ADS1X15Wrapper
void setComparatorPolarityADS1X15Wrapper(ADS1X15Wrapper instance, char polarity);

// Function to get the comparator polarity of the ADS1X15Wrapper
char getComparatorPolarityADS1X15Wrapper(ADS1X15Wrapper instance);

// Function to set the comparator latch of the ADS1X15Wrapper
void setComparatorLatchADS1X15Wrapper(ADS1X15Wrapper instance, char latch);

// Function to get the comparator latch of the ADS1X15Wrapper
char getComparatorLatchADS1X15Wrapper(ADS1X15Wrapper instance);

// Function to set the comparator queue conversion of the ADS1X15Wrapper
void setComparatorQueConvertADS1X15Wrapper(ADS1X15Wrapper instance, char mode);

// Function to get the comparator queue conversion of the ADS1X15Wrapper
char getComparatorQueConvertADS1X15Wrapper(ADS1X15Wrapper instance);

// Function to set the comparator threshold low of the ADS1X15Wrapper
void setComparatorThresholdLowADS1X15Wrapper(ADS1X15Wrapper instance, int threshold);

// Function to get the comparator threshold low of the ADS1X15Wrapper
int getComparatorThresholdLowADS1X15Wrapper(ADS1X15Wrapper instance);

// Function to set the comparator threshold high of the ADS1X15Wrapper
void setComparatorThresholdHighADS1X15Wrapper(ADS1X15Wrapper instance, int threshold);

// Function to get the comparator threshold high of the ADS1X15Wrapper
int getComparatorThresholdHighADS1X15Wrapper(ADS1X15Wrapper instance);

// Function to get the error code of the ADS1X15Wrapper
char getErrorADS1X15Wrapper(ADS1X15Wrapper instance);
