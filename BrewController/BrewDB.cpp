...
SensorState BrewDB::generateFakeSensorState(uint32_t iteration) {
  ...
  sensorState.timeSinceBrewStart = std::chrono::system_clock::now() - std::chrono::milliseconds(static_cast<int>(randomFloat(0.0f, 60000.0f)));
  sensorState.timeSinceSystemStart = std::chrono::system_clock::now() - std::chrono::milliseconds(static_cast<int>(randomFloat(0.0f, 100000.0f)));
