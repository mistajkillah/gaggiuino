...
public:
  ADS1X15(I2cBus * bus, uint8_t devAddr, const char * name);
  void     reset();
...
{
public:
  ADS1013(I2cBus * bus,  const char * name,uint8_t devAddr=ADS1015_ADDRESS);//, TwoWire *wire = &Wire);
};
...
{
public:
  ADS1014(I2cBus * bus,  const char * name,uint8_t devAddr=ADS1015_ADDRESS);//, TwoWire *wire = &Wire);
};
...
{
public:
  ADS1015(I2cBus * bus,  const char * name,uint8_t devAddr=ADS1015_ADDRESS);//, TwoWire *wire = &Wire);
...
{
public:
  ADS1113(I2cBus * bus,  const char * name,uint8_t devAddr=ADS1115_ADDRESS);//, TwoWire *wire = &Wire);
};
...
{
public:
  ADS1114(I2cBus * bus,  const char * name,uint8_t devAddr=ADS1115_ADDRESS);//, TwoWire *wire = &Wire);
};
...
{
public:
  ADS1115 (I2cBus * bus,  const char * name,uint8_t devAddr=ADS1115_ADDRESS);//, TwoWire *wire = &Wire);
  int16_t  readADC_Differential_0_3();
  int16_t  readADC_Differential_1_3();
  int16_t  readADC_Differential_2_3();
  int16_t  readADC_Differential_0_2();   //  not possible in async
